    ...
    <div class="bg-papel/50 border border-gray-200 p-6 md:p-8">
      ...
      {currentStep === 1 && (
        <div class="space-y-6">
          ...
          <div>
            <label htmlFor={fieldIds.nombre} class="block text-sm mb-2">Nombre completo *</label>
            <Input
              id={fieldIds.nombre}
              type="text"
          ...
          <div>
            <label htmlFor={fieldIds.email} class="block text-sm mb-2">Email *</label>
            <Input
              id={fieldIds.email}
              type="email"
          ...
          <div>
            <label htmlFor={fieldIds.telefono} class="block text-sm mb-2">Teléfono *</label>
            <Input
      ...
      {currentStep === 2 && (
        <div class="space-y-6">
          ...
          <div>
            <label htmlFor={fieldIds.direccion} class="block text-sm mb-2">Dirección *</label>
            <Input
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor={fieldIds.ciudad} class="block text-sm mb-2">Ciudad *</label>
              <Input
                id={fieldIds.ciudad}
                type="text"
            ...
            <div>
              <label htmlFor={fieldIds.departamento} class="block text-sm mb-2">Departamento *</label>
              <select
          ...
          <div>
            <label htmlFor={fieldIds.notas} class="block text-sm mb-2">Notas adicionales</label>
            <textarea
              id={fieldIds.notas}
