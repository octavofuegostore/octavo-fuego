  ...
  if (items.length === 0 && currentStep !== 4) {
    return (
      <div class="text-center py-12">
        ...
        <Button onClick={() => window.location.href='/tienda'}>Ir a la tienda</Button>
      </div>
    );
  }
      ...
      {currentStep === 4 && (
        <div class="text-center py-8">
          ...
          <div class="flex flex-col gap-4 max-w-md mx-auto">
            <Button onClick={() => window.open(`https://wa.me/573001234567?text=Hola, acabo de hacer un pedido y me gustaría confirmar`, '_blank')}>
            ...
            <Button variant="secondary" onClick={() => window.location.href='/tienda'}>
              Continuar comprando
            </Button>
          </div>
        </div>
