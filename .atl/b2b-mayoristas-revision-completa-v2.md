...
❌ Esto es contenido fantasma — Google indexa "Sananga" en la description pero no encuentra la palabra en el body. Mala señal para SEO on-page.
...
**Body copy:**
> "*Nota: También disponemos de aplicadores auto-inyectores (Kuripes) clásicos y de doble soplado tallados artesanalmente disponibles para compra en volumen como complemento indispensable.*"
...
❌ Un facilitador individual compra 500g para uso propio. Una tienda compra kilos para revender. Son necesidades, objeciones y volúmenes completamente distintos. La landing los trata como si fueran el mismo comprador.
...
❌ La landing dice "precios escalonados" y "tarifas de distribución" pero nunca comunica POR QUÉ Octavo Fuego puede ofrecer mejor precio. El doc dice que la razón es "origen directo sin intermediarios". La landing menciona "comercio justo con comunidades" pero no conecta esto con el COSTO.
...
❌ La landing actual probablemente no tiene estas etiquetas. Verificar.
...
**El doc no especifica title explícito**, pero el patrón de todas las otras páginas es: `{keyword principal} | Octavo Fuego`. El title actual usa "Rapé Amazónico" en vez de "Rapé do Acre", que es el término consistente en todo el doc.
...
**FAQ actual:**
> "Para la operación en Colombia, aceptamos transferencias... Para la operación en Brasil, los pagos se centralizan mediante Pix..."

❌ Menciona operación en Brasil en una página del hub Colombia. Según §2, el hub Brasil (`octavofogo.com.br/atacado/`) debe manejar su propia información de pagos y logística.

---

### 9. Los 3 pilares no mencionan PRECIO como cuarto pilar (§1)

**La landing tiene 3 pilares:**
1. Conservación (empacado al vacío)
2. Trazabilidad (comercio justo)
3. Logística (transfronteriza)

**El doc dice que el diferenciador central es PRECIO + ORIGEN DIRECTO.**

❌ La landing omite el cuarto pilar — el que más convierte. Sugiero agregar:
...
❌ El body copy no menciona cobertura geográfica explícita para Colombia. Dice "transportadoras locales aliadas" y "3 a 5 días hábiles dentro del territorio nacional" pero no especifica que "territorio nacional" = Colombia. En una landing B2B, la cobertura geográfica debe ser explícita.

---

## 📊 Resumen: 10 hallazgos nuevos
...
1. **Eliminar "y Brasil" de meta description + body** — el hub CO solo habla a Colombia
2. **Agregar cuarto pilar: Precio de Origen** — sin mostrar números, comunicar la ventaja
3. **Eliminar "Sananga" de meta** O agregar sección de Sananga en body
4. **Activar hreflang** en la landing
5. **FAQ Colombia** solo debe hablar de operación en Colombia
