...
|-------|----------|------------------|
| **URLs `/catalogo/` vs `/tienda/`** | El doc arquitectura usa `/tienda/`, código ya usa `/tienda/` | ✅ YA MIGRADO — ver plan-migracion-urls.md |
...
*⚠️ NOTA: PENDIENTES.md sufrió inconsistencia de filesystem. Este archivo es la referencia. Debe copiarse manualmente a /octavo-fuego/PENDIENTES.md*